...
#----| Minimizing |-----------
args=(g.N, var, B_sqrt_op, B_sqrt_op_T, H, obs, R_inv, rCTilde_sqrt)
xi_a, out=sciOpt.fmin_bfgs(costFunc, xi, fprime=gradCostFunc,  
                args=args, retall=True, maxiter=100)

#----| Gradient test |--------
resultGradTest=gradTest(costFunc, gradCostFunc, xi_a, g.N, var, B_sqrt_op,
                        B_sqrt_op_T, H, obs, R_inv, rCTilde_sqrt, 
                        verbose=True)


#----| Analysis |-------------
x_a=B_sqrt_op(xi_a, g.N, var, rCTilde_sqrt)
